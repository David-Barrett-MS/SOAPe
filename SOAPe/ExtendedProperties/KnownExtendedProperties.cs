...
{
    public class KnownExtendedProperties
    {
        public readonly Dictionary<ExtendedPropertyDefinition, KnownExtendedPropertyInfo> PropertyDictionary = new Dictionary<ExtendedPropertyDefinition, KnownExtendedPropertyInfo>();

        public KnownExtendedProperties()
        {
            InitializeList();
        }

        public ExtendedPropertyDefinition GetDefinitionByCanonicalNames(string canonicalName)
        {
            // We've been passed the canonical name, and need to return the matching property
            foreach (ExtendedPropertyDefinition propDef in PropertyDictionary.Keys)
                if (PropertyDictionary[propDef].CanonicalNames.Equals(canonicalName))
                    return propDef;
            return null;
        }
